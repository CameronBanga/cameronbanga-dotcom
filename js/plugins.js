...
$(document).ready(function(){
	...
	/* googleMaps Footer Map */
		...
		var latlng = new google.maps.LatLng(41.469704,-87.062121); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		var styles = [
			{
		...
		var point0 = new google.maps.LatLng(41.469704,-87.062121); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
